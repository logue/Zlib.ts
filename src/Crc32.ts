const ZLIB_CRC32_COMPACT: boolean = false;
...
export default class CRC32 {
   ...
   */
  static calc(data: Uint8Array, pos?: number, length?: number): number {
  ...
  private static update(
    ...
    let i = pos;
    const il = length ? length : data.length;
   ...
   * CRC-32 Table.
   */
  private static Table: Uint32Array = ZLIB_CRC32_COMPACT
    ? (() => {
